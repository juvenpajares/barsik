            ...
            <nav className="relative z-50 w-full max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-full bg-barsik-green flex items-center justify-center shadow-[0_0_20px_rgba(0,255,163,0.6)] cursor-pointer">
                        <img src="./src/assets/barsik/Logo.png" alt="Logo" className="rounded-full w-full h-full object-cover" />
                    </div>
                </div>
            ...
            <section className="relative z-10 max-w-6xl mx-auto mt-12 mb-32 px-6 flex flex-col md:flex-row items-center justify-center gap-12">
                ...
                <div className="relative w-64 h-64 md:w-80 md:h-80 flex-shrink-0">
                    ...
                    <div className="absolute">
                        ...
                        <img src="./src/assets/barsik/cat.png" alt="Barsik" className="w-full h-full object-cover transform hover:scale-110 transition-transform duration-700" />
                    </div>
                </div>

                {/* Hero Text */}
                <div className="text-center md:text-left">
                    <h1 className="font-marker text-6xl md:text-8xl mb-2 leading-tight">
                        <span className="text-barsik-green drop-shadow-[0_0_10px_rgba(0,255,163,0.5)]">10X</span> Barsik
                    </h1>
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 mb-20">
                <div className="text-center mb-20">
                    <h2 className="font-marker text-3xl md:text-4xl uppercase tracking-wider inline-block relative">
                        ...
                        <img src="src/assets/barsik/divider.svg" className="ml-auto mr-auto w-full max-w-100 mt-10" />
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 items-end max-w-5xl mx-auto px-4">
                    ...
                    <PricingCard
                        ...
                        imgSrc="src/assets/barsik/shrimp.svg"
                    />
                    ...
                    <PricingCard
                        ...
                        imgSrc="src/assets/barsik/dolphin.svg"
                    />
                    ...
                    <PricingCard
                        ...
                        imgSrc="src/assets/barsik/whale.svg"
                    />
                </div>
            </section>

            {/* ================= HOW DOES IT WORK? ================= */}
            <section className="relative z-10 bg-[#0F1420]/80 py-24 backdrop-blur-sm border-t border-white/5">

                <div className="text-center mb-24">
                    <h2 className="font-marker text-4xl md:text-5xl text-barsik-green uppercase drop-shadow-md">
                        How Does It Work?
                    </h2>
                </div>
            ...
            <footer className="py-20 text-center relative z-10 w-full bg-[#080c14] border-t border-white/5">
                ...
                <div className="flex justify-center items-center gap-10">
                    ...
                    <div className="w-16 h-16 rounded-full bg-barsik-green flex items-center justify-center text-black cursor-pointer hover:scale-110 transition-transform shadow-[0_0_30px_rgba(0,255,163,0.4)]">
                        <img src="src/assets/barsik/Logo.png" className="w-full h-full rounded-full opacity-80" />
                    </div>
                </div>
            </footer>
